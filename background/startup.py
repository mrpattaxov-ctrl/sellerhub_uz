...
def start_background_threads():
    ...
    if os.environ.get("NEW_SALES_REPORTS_LOOPS", "1").strip().lower() not in ("0", "false", "no"):
        ...
        print("[Background] Started: Finance loops (hourly, nightly-refetch, expenses-daily)")



    # Background products/stock loop starter
    ...
    #start of auto login to uzum market to get browser token
