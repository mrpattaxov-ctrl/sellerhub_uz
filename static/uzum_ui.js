(function () {
  ...
  function initUzumUI() {
    ...
    links.forEach(l => {
      ...
      // FBS/DBS is one section spanning /fbs and its children (/fbs/invoices,
      // /fbs/stock, /fbs/<id>) — highlight the parent link for any /fbs/ path.
      const _path = window.location.pathname;
      const isFbsSection = l.href === "/fbs" && (_path === "/fbs" || _path.startsWith("/fbs/"));
      if (_path === l.href || (l.href === "/groups" && _path === "/") || isFbsSection) {
